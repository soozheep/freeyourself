const SITE_URL = 'https://freeyourself.vercel.app';
  ...
  if (navigator.share) {
    try {
      await navigator.share({
        title: 'Free Yourself — Sonic Remedy | Soozhee',
        text: 'Free yourself from the things holding you back. Free Yourself by Soozhee.',
        url: SITE_URL
      });
      return;
    } catch (e) {}
